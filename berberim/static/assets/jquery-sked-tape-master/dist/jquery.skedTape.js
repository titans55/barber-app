...
SkedTape.prototype = {
	...
	removeCreatedEventStartAddingNewOne: function(newDuration, newEventName, opts) {
		let events = this.getEvents()
		console.log(events)
		this.removeEvent(createdEvent.id);
		this.startAdding({
			id: createdEvent.id,
			name: newEventName,
	...
	handleEventClick: function(e) {
		...
		if (this.isEditMode()) {
			...
			if (this.isAdding() || event.disabled) return;
            ...
            switch (cmd) {
				...
				default:
					var methods = [
						...
						'removeCreatedEventStartAddingNewOne',
